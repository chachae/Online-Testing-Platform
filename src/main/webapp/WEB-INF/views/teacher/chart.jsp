...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form method="get" action="<c:url value="/score/courseChart"/>">
                <div class="form-group">
                    <label class="control-label col-sm-2"><h4 style="font-weight: 800">请选择课程</h4></label>
                    <div class="col-sm-8">
                        <select class="form-control " id="courseId" name="courseId" style="width: 100%">
...
<script src="<c:url value="/static/dist/js/echarts.min.js"/>"></script>
